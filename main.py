...
def main():
    ...
    mycar = carmodule.car(car_image, (display_width*0.45), (display_height*0.8), boundary_left = 100, boundary_right = 700)    #Create object for first car with default key_bindings
    '''
